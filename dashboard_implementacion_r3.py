...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .nav-mobile-menu ul {{ list-style: none; margin: 0; padding: 0.5rem 0 1rem; }}
    ...
    .nav-mobile-menu li a:hover {{ background: rgba(255,255,255,0.07); color: #fff; }}
...
<nav class="navbar">
  <div class="navbar-content">
    ...
    <button class="nav-hamburger" id="navHamburger" onclick="toggleMobileNav()" aria-label="Abrir menú">
